...
function loadWalletEvents() {
    ...
    $('#user-profile-lend-tab').click(function () {
        $('#user-profile-lend').show(500);
        $('#user-profile-borrow').hide(500);
    });

    $('#user-profile-borrow-tab').click(function () {
        $('#user-profile-borrow').show(500);
        $('#user-profile-lend').hide(500);
    });
